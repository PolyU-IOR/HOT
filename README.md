...
In most of the cases, you just need to $${\color{blue}\textbf{slightly change the image paths and desired crop size in demo.py}}$$. You can also adapt this pipeline to suit your project's needs. 
